            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('number') || $errors->has('complement') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                <input id="name" type="text" class="form-control" name="complement" placeholder="Complement" value="{{ old('complement') }}">
                        ...
                        <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                            <label for="number" class="col-md-4 control-label">City</label>
                            <div class="col-md-6">
